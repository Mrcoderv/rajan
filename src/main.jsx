...
function YouTubeEmbed() {
  const embedUrl = 'https://www.youtube.com/embed?listType=user_uploads&list=Rajan_Aryal'

  return <div className="feed-frame youtube-frame"><iframe src={embedUrl} loading="lazy" title="YouTube channel uploads from Rajan Aryal" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen /></div>
}
